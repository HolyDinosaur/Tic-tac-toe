...
debug_handler = logging.FileHandler("./log/games_tic-tac-toe-debug_info.log", mode='w')
debug_handler.setLevel(logging.DEBUG)
debug_format = logging.Formatter('%(asctime)s - %(levelname)s - %(message)s')
debug_handler.setFormatter(debug_format)

warning_handler = logging.FileHandler("./log/games_tic-tac-toe-warnings_errors.log", mode='w')
